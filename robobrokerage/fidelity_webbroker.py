...
def goto_and_resolve(driver, *candidates):
	...
	candidates[0].wait_page_loaded(driver)
...
class fidelity_webbroker:
	...
	# --
	def get_history(self, *, subacct, days_opt='10', include_raw=False, include_details=True):
		m_act = self.goto_activity()
		...
		m_act.wait_page_loaded(self.driver)
		raw_transactions = m_act.raw_transactions(self.driver, incl_details=include_details)
