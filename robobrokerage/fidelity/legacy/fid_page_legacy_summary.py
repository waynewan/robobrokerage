...
# --
# --
URL_PAGE = "https://oltx.fidelity.com/ftgw/fbc/oftop/portfolio#summary"
# --
XP_PAGE_ID1 = '//a[text()[.="Classic experience"]]'
XP_MODERN_PAGE_BTN = '//a[text()[.="Classic experience"]]'
# --
...
# -- actions
# --
def goto_modern(driver):
	try:
		legacy_btn = driver.find_element(By.XPATH,XP_MODERN_PAGE_BTN)
		legacy_btn.click()
		return True
	except:
		return False
