...
# --
URL_PAGE = "--n/a--"
XP_USERNAME_INP = '//input[@id="dom-username-input"]'
XP_PASSWORD_INP = '//input[@id="dom-pswd-input"]'
XP_LOGIN_BTN = '//button[@id="dom-login-button"]'
PAGE_STATUS_UNKNOWN = "__PAGE_STATUS_UNKNOWN__"
PAGE_STATUS_OK = "__PAGE_STATUS_OK__"


def match(driver):
	return len(driver.find_elements(By.XPATH, XP_USERNAME_INP)) > 0
