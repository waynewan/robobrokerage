...
# --
# !! some of the transformations may look odd;
# !! they are designed to match the output format of fid_page_activity
# --
...
# --
# !! some of the transformations may look odd;
# !! they are designed to match the output format of fid_page_position
# --
...
# --
# -- Fidelity CSV exports have header/footer rows mixed in;
# -- key_col rows are used to strip non-data rows
# --
def read_dirty_csv(filepath, header_row=1, date_col=[], num_col=[], key_col=[]):
	try:
		df = pandas.read_csv(filepath, engine='python', skip_blank_lines=True, header=header_row)
