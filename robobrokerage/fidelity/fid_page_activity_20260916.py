...
XP_DATE_SELECTOR_DD = "//filter-by-time//fds-activity-button"
XP_DATE_SELECTOR_OPT = '//filter-by-time/section//fds-activity-radio-group//fds-activity-radio'
...
XP_ACT_EXEC_COLLAPSED = ".//fds-activity-button[@fds-icon-left='collapsed']"
XP_ACT_EXEC_EXPANDED = ".//fds-activity-button[@fds-icon-left='expanded']"
